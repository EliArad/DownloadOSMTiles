...
namespace DownloadOSMTiles
{
    ...
    {
        public delegate void EventXHandler(POINT pt);
        public delegate void EventX2Handler();

        public static event EventX2Handler LeftMouseDownAction = delegate { };
        public static event EventX2Handler LeftMouseUpAction = delegate { };
